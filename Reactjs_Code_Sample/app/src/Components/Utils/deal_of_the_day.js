export const deal_Of_The_Products = [
  {
    id: "product1",
  ...
  {
    id: "product3",
    url: "https://rukminim1.flixcart.com/image/150/150/jnxhx8w0/kurta/e/h/6/xxl-lt-kt-um-073-50-get-glamr-original-imafah5syj7k8mye.jpeg?q=70",
    detailUrl:
      "https://rukminim1.flixcart.com/image/150/150/jnxhx8w0/kurta/e/h/6/xxl-lt-kt-um-073-50-get-glamr-original-imafah5syj7k8mye.jpeg?q=70",
    title: {
      shortTitle: "Newly Launched",
      longTitle:
        "Are you looking for a stylish kurti to wear to the next family outing?",
    },
    price: {
      mrp: 499,
      cost: 166,
    ...
    description:
      "Are you looking for a stylish kurti to wear to the next family outing? If yes, you can find a plethora of styles, designs, and patterns to choose from across shopping websites. Whatever be your requirement or the occasion, you will find this perfect ethnic wear meets all your needs. In terms of fabrics and colours, you will never fall short of choices. You can choose from rayon, pure cotton, cotton blend, pure khadi, wool blend, and many more. Look your best and stand out in the crowd by wearing one of the many stylish designs available online. Opt for sheer classics, resham florals, minimal colour-block, velvet kurtas, and many more and start a style trend. When browsing through the latest kurti collection online, be sure to check out the fit and the size of the garment",
    discount: "Upto 70% Off",
    tagline: "Kurts & Kurtis",
  },
  {
    id: "product4",
